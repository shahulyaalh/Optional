...
const Gallery = () => {
  ...
  useEffect(() => {
    const fetchActivities = async () => {
      try {
        const res = await axios.get(`https://stair-deploy-6.onrender.com/api/activities`)
...
const CanvasImage = ({ imageData }) => {
  ...
  return (
    <canvas ref={canvasRef} className="w-full h-48 object-cover rounded" style={{ width: "100%", height: "192px" }} />
  )
}
